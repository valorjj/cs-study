...
<details class="deep">
<summary>심화: TLAB — Thread-Local Allocation Buffer (Heap 할당 성능)</summary>
...
<details class="deep">
<summary>심화: Reference Types — Strong / Soft / Weak / Phantom</summary>
...
<details class="deep">
<summary>심화: 자바 메모리 누수 패턴과 진단 (GC가 있어도 새는 이유)</summary>
...
<details class="deep">
<summary>심화: GC 튜닝 — 힙 크기 & 컬렉터 선택</summary>
...
<details class="deep">
<summary>심화: JVM 관측 도구 — jps / jstat / jmap / jstack & Heap Dump</summary>
...
<details class="deep">
<summary>심화: Escape Analysis — 스칼라 치환·스택 할당</summary>
